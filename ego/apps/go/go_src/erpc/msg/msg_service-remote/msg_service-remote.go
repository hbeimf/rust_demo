...
func Usage() {
	...
	fmt.Fprintln(os.Stderr, "  Message hello(Message m)")
	fmt.Fprintln(os.Stderr, "  ServerReply AddUser(UserInfo info)")
	fmt.Fprintln(os.Stderr, "  ServerReply UpdateUser(UserInfo info)")
	fmt.Fprintln(os.Stderr)
	os.Exit(0)
}
...
func main() {
	...
	client := msg.NewMsgServiceClientFactory(trans, protocolFactory)
	...
	case "UpdateUser":
		...
		value0 := argvalue0
		fmt.Print(client.UpdateUser(value0))
		fmt.Print("\n")
		break
	case "":
		Usage()
