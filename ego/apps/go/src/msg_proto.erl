...
-type 'Login'() :: #'Login'{}.
-export_type(['RpcPackage'/0, 'AesDecode'/0, 'Payload'/0, 'TestMsg'/0, 'AesDecodeReply'/0, 'AesEncode'/0, 'Login'/0]).

-spec encode_msg(#'RpcPackage'{} | #'AesDecode'{} | #'Payload'{} | #'TestMsg'{} | #'AesDecodeReply'{} | #'AesEncode'{} | #'Login'{}) -> binary().
encode_msg(Msg) -> encode_msg(Msg, []).


-spec encode_msg(#'RpcPackage'{} | #'AesDecode'{} | #'Payload'{} | #'TestMsg'{} | #'AesDecodeReply'{} | #'AesEncode'{} | #'Login'{}, list()) -> binary().
encode_msg(Msg, Opts) ->
...
get_msg_names() ->
    ['RpcPackage', 'AesDecode', 'Payload', 'TestMsg',
     'AesDecodeReply', 'AesEncode', 'Login'].
