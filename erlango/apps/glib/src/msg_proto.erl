...
-export_type(['RpcPackage'/0, 'AesDecodeReply'/0, 'TestMsg'/0, 'Login'/0, 'AesEncode'/0, 'AesDecode'/0, 'Payload'/0]).

-spec encode_msg(#'RpcPackage'{} | #'AesDecodeReply'{} | #'TestMsg'{} | #'Login'{} | #'AesEncode'{} | #'AesDecode'{} | #'Payload'{}) -> binary().
encode_msg(Msg) -> encode_msg(Msg, []).


-spec encode_msg(#'RpcPackage'{} | #'AesDecodeReply'{} | #'TestMsg'{} | #'Login'{} | #'AesEncode'{} | #'AesDecode'{} | #'Payload'{}, list()) -> binary().
encode_msg(Msg, Opts) ->
...
get_msg_names() ->
    ['RpcPackage', 'AesDecodeReply', 'TestMsg', 'Login',
     'AesEncode', 'AesDecode', 'Payload'].
