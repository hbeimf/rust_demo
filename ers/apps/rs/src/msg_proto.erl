...
-export_type(['AesEncode'/0, 'TestMsg'/0, 'Login'/0, 'AesDecodeReply'/0, 'Payload'/0, 'RpcPackage'/0, 'AesDecode'/0]).

-spec encode_msg(#'AesEncode'{} | #'TestMsg'{} | #'Login'{} | #'AesDecodeReply'{} | #'Payload'{} | #'RpcPackage'{} | #'AesDecode'{}) -> binary().
encode_msg(Msg) -> encode_msg(Msg, []).


-spec encode_msg(#'AesEncode'{} | #'TestMsg'{} | #'Login'{} | #'AesDecodeReply'{} | #'Payload'{} | #'RpcPackage'{} | #'AesDecode'{}, list()) -> binary().
encode_msg(Msg, Opts) ->
...
get_msg_names() ->
    ['AesEncode', 'TestMsg', 'Login', 'AesDecodeReply',
     'Payload', 'RpcPackage', 'AesDecode'].
