...
create_pool(PoolName, Size, Host, Port) ->
    redisc_sup:create_pool(PoolName, Size, [{host, Host}, {port, Port}]).
...
delete_pool(PoolName) ->
    redisc_sup:delete_pool(PoolName).
