...
CREATE TABLE `posts` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='test';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `posts` VALUES (11,'titletest','body test',0),(12,'titletest','body test',0),(13,'titletest','body test',0);
...
-- Dump completed on 2018-09-26 13:31:08
