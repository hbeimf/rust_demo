...
-type 'Login'() :: #'Login'{}.
-export_type(['RpcPackage'/0, 'AesDecodeReply'/0, 'Payload'/0, 'AesDecode'/0, 'AesEncode'/0, 'TestMsg'/0, 'Login'/0]).

-spec encode_msg(#'RpcPackage'{} | #'AesDecodeReply'{} | #'Payload'{} | #'AesDecode'{} | #'AesEncode'{} | #'TestMsg'{} | #'Login'{}) -> binary().
encode_msg(Msg) -> encode_msg(Msg, []).


-spec encode_msg(#'RpcPackage'{} | #'AesDecodeReply'{} | #'Payload'{} | #'AesDecode'{} | #'AesEncode'{} | #'TestMsg'{} | #'Login'{}, list()) -> binary().
encode_msg(Msg, Opts) ->
...
get_msg_names() ->
    ['RpcPackage', 'AesDecodeReply', 'Payload', 'AesDecode',
     'AesEncode', 'TestMsg', 'Login'].
